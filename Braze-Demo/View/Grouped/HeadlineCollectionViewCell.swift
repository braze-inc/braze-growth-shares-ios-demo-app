...
class HeadlineCollectionViewCell: UICollectionViewListCell {
  ...
  static func configuredCell() ->  UICollectionView.CellRegistration<HeadlineCollectionViewCell, GroupItem> {
    return UICollectionView.CellRegistration<HeadlineCollectionViewCell, GroupItem> { (cell, indexPath, subgroup) in
